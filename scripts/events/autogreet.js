...
const greetings = {
  morning: [
    { time: "8:00 AM", message: 'Its time to wake up nigga },
  ...
  afternoonSnack: [
    { time: "3:00 PM", message: "its time to pray for Jesus Christ" },
  ...
  eveningDinner: [
    ...
    { time: "8:00 PM", message: "Remember God is always on your side -Aljur Pogoy" },
  ],
  lateNightSnack: [
